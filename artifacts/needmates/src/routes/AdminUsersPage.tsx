  ...
  return (
    <AdminShell pageTitle="User Management">
      <div className="space-y-5">
        <div className="flex flex-wrap items-center gap-3 text-sm font-bold text-muted-foreground bg-card border-2 border-border rounded-2xl px-5 py-3">
            ...
            <table className="w-full text-sm">
              <thead className="border-b-2 border-border bg-muted/50">
                <tr>
                  ...
                  <th className="text-left font-black px-3 py-3 text-muted-foreground hidden sm:table-cell">Location</th>
                  <th className="text-left font-black px-3 py-3 text-muted-foreground hidden md:table-cell">Needs</th>
                  <th className="text-left font-black px-3 py-3 text-muted-foreground hidden md:table-cell">Vouches</th>
                ...
                {paginated.map((user, i) => {
                  ...
                  return (
                    <tr key={user.id} className={cn('border-b border-border last:border-0', i % 2 === 1 && 'bg-muted/20')} data-testid={`user-row-${user.id}`}>
                      ...
                      <td className="px-3 py-4 font-bold hidden md:table-cell">{needCount}</td>
                        ...
                        <div className="flex items-center justify-end gap-2 flex-wrap">
                          ...
                          {confirmRemove === user.id ? (
                            ...
                            <Button
                              ...
                              data-testid={`btn-remove-user-${user.id}`}
                            >Remove</Button>
                          )}
                        </div>
                      </td>
